<%-- 
    ...
    Created on : 15 Jul, 2022, 11:42:05 AM
    Author     : Genius
--%>
                                ...
                                <div class="col-sm-6">
                                    <form method="post" action="save_profile.jsp">
                                            <table class="table table-borderless">
                                                <tr>
                                                    <td><strong>User Name :</strong></td><td><strong><input type="text" name="user" value="<%=rs.getString("name")%>" class="form-control"></strong></td></td>
                                                </tr>
                                                 
                                                <tr>
                                                    <td><strong>Country :</strong></td><td><strong><select name="country" class="form-control"><option value="<%=rs.getString("country")%>"><%=rs.getString("country")%></option><option value="pakisthan">pakisthan</option><option value=" Australia">Australia</option></select></strong></td></td>
                                                                                                                                                                                                        
                                                </tr>
                                                <tr>
                                                    <td><a href="save_profile.jsp"><button class="btn btn-success">Save Profile</button></a></td>
                                                </tr>
                                            </table>
                                    </form>
                                 </div>
