<%-- 
    Document   : my_favorite
    Created on : 12 Jul, 2022, 10:50:58 AM
    Author     : Genius
--%>
		...
		<!-- //header-ends -->
			<div id="page-wrapper">
                            <div class="col-sm-12 w3-card">
                                <center><h3><strong>Your Favorite Song</strong></h3></center><br><br><br>
                                <%
                                 Statement st1 = cn.createStatement();
                                 ResultSet rs1 = st1.executeQuery("select * from favorite where email='"+email+"'");
                                 out.print("<table class='table table-borderless'>");
                                 while(rs1.next()){
                                     Statement st2 = cn.createStatement();
                                     ResultSet rs2 = st2.executeQuery("select * from song where code='"+rs1.getString("code")+"'");
                                     if(rs2.next()){
                                         String album_code = rs2.getString("album_code");
                                         int so = rs2.getInt("sn");
                                         %>
                                <tr> 
                                    <td><strong><%=rs2.getInt("sn")%></strong></td>
                                    <td><strong><%out.print(rs2.getString("song_name"));%></strong></td>
                                    <td>
                                        <audio controls><source src="album/<%=album_code+'/'+so%>.mp3" type="audio/mp3"></audio>
                                    </td>
                                    <td>
                                        <i style="font-size:25px;color:red;" class ="fa fa-heart"></i>
                                    </td>
                                </tr>
                                         <%
                                     }
