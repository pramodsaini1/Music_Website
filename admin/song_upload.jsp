<%-- 
    ...
    Created on : 2 Jul, 2022, 9:14:54 AM
    Author     : Genius
--%>
...
if(email==null && session.getAttribute(email)==null){
    ...
    try{
        ...
        if(rs.next()){
            if(request.getParameter("code")==null && request.getParameter("album_code")==null&& request.getParameter("cat_code")==null){
  ...
  <div class="row">			
        <div class="col-sm-12 w3-card w3-white">
            <%
                 ...
                 ResultSet rs1 = st1.executeQuery("select * from song where code='"+code+"' AND status=0");
                 if(rs1.next()){
            %>
           <div class="col-sm-12"><center><h2><strong><%out.print(rs1.getString("song_name"));%></strong></h2></center></div>
           <%
                 }
            %>
           <form method="post" ACTION="SongUploadProcess.jsp?cat_code=<%=cat_code%>&album_code=<%=album_code%>" name="uploadForm" ENCTYPE='multipart/form-data'>
