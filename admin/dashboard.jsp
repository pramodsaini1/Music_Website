<%-- 
    Document   : dashboard
    Created on : 6 May, 2022, 6:09:02 PM
    Author     : Genius
--%>
               ...
               $(document).on("click",".fa.fa-save",function(){
                ...
                $(document).on("click",".fa.fa-trash-o",function(){
                    var code = $(this).attr("rel");
                     $.post(
                         "delete_cat.jsp",{code:code},function(data){
                            if(data.trim()=="success"){
                                $("#r"+code).fadeOut(1000);
                            }
                         }
  ...
  <div class="row">			
        <div class="col-sm-12 w3-card w3-blue">
           ...
           <form method="post" action="add_category.jsp">
               ...
               <input type="text" name="category" class="form-control" placeholder="Add Your Category.."><br>
    ...
    <div class="row">
         <div class="col-sm-12 w3-card w3-white">
            ...
            <tr id="r<%=rs1.getString("code")%>">
                <td id="d<%=rs1.getString("code")%>"><strong><%=rs1.getString("category_name")%></strong></td>
                <td><button class="btn btn-warning"><a href="add_album.jsp?code=<%=rs1.getString("code")%>"><i class="fa fa-plus"></i>Add Album</a></button> </td>
                <td><i id="<%=rs1.getString("code")%>"style="font-size:25px;color:blue;cursor:pointer;" class="fa fa-edit"></i></td>
                <td><i rel="<%=rs1.getString("code")%>" style="font-size:25px;color:red;cursor:pointer;" class="fa fa-trash-o"></i></td>  
            </tr>
