<%-- 
    ...
    Created on : 24 Jun, 2022, 2:53:09 PM
    Author     : Genius
--%>
...
if(email==null && session.getAttribute(email)==null){
    ...
    try{
        ...
        if(rs.next()){
            if(request.getParameter("code")==null && request.getParameter("album_code")==null){
  ...
  <div class="row">			
        <div class="col-sm-12 w3-card w3-white">
            <%
                 ...
                 ResultSet rs1 = st1.executeQuery("select * from album where code='"+album_code+"' AND status=0");
                 if(rs1.next()){
            %>
           <div class="col-sm-12"><center><h2><strong><%out.print(rs1.getString("album_name"));%> Image</strong></h2></center></div>
           <%
                 }
            %>
           <form method="post" ACTION="ImageUploadProcess.jsp?cat_code=<%=code%>&album_code=<%=album_code%>" name="uploadForm" ENCTYPE='multipart/form-data'>
